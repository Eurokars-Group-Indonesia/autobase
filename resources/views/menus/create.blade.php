                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('menu_code') is-invalid @enderror" 
                                   name="menu_code" value="{{ old('menu_code') }}" required>
                            @error('menu_code')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('menu_name') is-invalid @enderror" 
                                   name="menu_name" value="{{ old('menu_name') }}" required>
                            @error('menu_name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('menu_url') is-invalid @enderror" 
                                   name="menu_url" value="{{ old('menu_url') }}" placeholder="/dashboard">
                            @error('menu_url')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('menu_icon') is-invalid @enderror" 
                                   name="menu_icon" value="{{ old('menu_icon') }}" placeholder="bi-house">
